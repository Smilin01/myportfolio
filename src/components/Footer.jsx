  ...
  return (
    <div className='bg-black px-5 lg:px-28 py-6 flex items-center justify-between mt-16'>
      <div className='flex items-center gap-4'>
        ...
        <a href='https://www.linkedin.com/in/' className='bg-white p-2 rounded-2xl border-2 border-black shadow-[8px_8px_0_0_rgba(255,255,255,0.1)] hover:scale-105 transition'>
